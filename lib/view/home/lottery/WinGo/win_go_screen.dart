...
import 'package:fapjoymall/model/bettingHistory_Model.dart';
...
import 'package:fapjoymall/view/DummyGrid.dart';
import 'package:fapjoymall/view/bottom/bottom_nav_bar.dart';
import 'package:fapjoymall/view/home/lottery/WinGo/imagetoastWingo.dart';
import 'package:fapjoymall/view/test.dart';
...
import 'package:fapjoymall/view/home/lottery/WinGo/commonbottomsheet.dart';
...
class WinGoScreen extends StatefulWidget {
  ...
  @override
  WinGoScreenState createState() => WinGoScreenState();
}

class WinGoScreenState extends State<WinGoScreen> with SingleTickerProviderStateMixin {
                                                ...
                                                Padding(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      textWidget(
                                                          text: items[index].status == "0"
                                                              ? "Pending" : items[index].status == "1"
                                                                  ? "Win"
                                                                  : "Loss",
                                                          fontSize:
                                                              width * 0.05,
