...
import 'package:fapjoymall/res/components/rich_text.dart';
...
import 'package:fapjoymall/view/wallet/account_view.dart';
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            textWidget(
                                text: withdrawCon.text==''?'0.0':(int.parse(withdrawCon.text)*0.98).toStringAsFixed(2),
                                fontSize: 20,
                                color: AppColors.gradientFirstColor),
                          ],
                        )
